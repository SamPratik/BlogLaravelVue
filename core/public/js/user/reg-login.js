...
var loginRegCom = new Vue({
  ...
  mounted: function mounted() {
    ...
    axios.get(urlUsernames).then(function (res) {
      console.log(res.data);
      for (var _i = 0; _i < res.data.length; _i++) {
        _this.usernames.push(res.data[_i].username);
      }
  ...
  watch: {
    username: function username() {
      ...
      if (this.usernames.length > 0) {
        for (var _i2 = 0; _i2 < this.usernames.length; _i2++) {
          if (this.usernames[_i2] == this.username) {
            this.unExist = true;
            return;
          }
        }
